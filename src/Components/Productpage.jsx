...
const Productpage = () => {
  return (
    <div className="">
      <AppLayout>
        <Link to="/">
        <button class="bg-[#326C77]  text-white font-bold py-2 px-4 rounded mt-5 mx-2 ">
          Back
        </button>
        </Link>
        <div class="grid sm:grid-cols-2 gap-4 grid-cols-1 bg-[#bce5f5] my-10">
          <div className="  flex  mx-2 sm:mx-auto">
            <div className="flex-col gap-4">
              <img
                src={pimg }
                alt=""
                className="h-[100px] sm:h-[200px] w-full  border-2 sm:border-4  border-[#326C77]"
              />
              <img
              src={pimg }
                alt=""
            ...
            <div className="">
              <img
               src={pimg }
                alt=""
                className=" h-[300px] sm:h-[600px] w-full border-2 sm:border-4  border-[#326C77]"
              />
            </div>
          </div>
          ...
          <div className="  mx-2 lg:mx-20">
            ...
            <div className=" w-[100%] sm:w-[80%]  mt-8 sm:mt-20">
              ...
              <button class="bg-[#326C77] hover:bg-[#326C77] text-white font-bold py-2 px-4 rounded  w-[100%]">
                Button
              </button>
              </a>
            </div>
